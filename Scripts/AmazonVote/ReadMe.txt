I - Describing Files
    ...
    2 - AmazonVote.py Is The Script To Perform Votes
    3 - BrowserCommon.py Is A Common Script Between Most Scripts
    4 - ReadMe.txt Is This Help File
    5 - Sample.csv Is A Sample Configuration File That Demonestrates The Format Used To Configure Vote Script
...
III - Notes
    ...
    7 - Stars Should Be 1 Or 2 Or 3 Or 4 Or 5
    8 - Direction Should Be Either -1 For Report Abuse Or 1 For Helpful
    9 - FromDelay And ToDelay Are Two Numbers That The Script Will Use To Wait For Random Time In Minutes Before Executing The Row
   ...
   10 - Keywords Can Be As Many Columns As You Want
   11 - The Script Saves Three Log Files SampleSucceededData.csv, SampleSucceeded.csv, and SampleFailed.csv
   12 - SampleSucceededData.csv Contains Data Of Rows That Have Been Completed Successfully
   13 - SampleSucceeded.csv Contains The Indexes Of Rows Along With Keywords That Have Been Completed Successfully
        And The Script Will Escape Those Keywords If You Rerun It
   14 - SampleFailed.csv Contains The Indexes Of Rows That Have Been Failed Along With The Reason Of Failure Which I Can Use To Debug The Failure
